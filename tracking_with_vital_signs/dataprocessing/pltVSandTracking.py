...
if __name__=='__main__':
    ...
    while 1:
        ...
        plt.plot(load_trk["1"][0], load_trk["1"][1], color='red', marker='o', markersize=15)
        plt.plot(load_trk["2"][0], load_trk["2"][1], color='red', marker='o', markersize=15)
        ...
        plt.text(0.1, 0.3, 'oximeter', fontdict={'size': 12})
        plt.text(1.1, 0.3, result['1']['oximeter'], fontdict={'size': 30})
        plt.text(2.1, 0.3, result['2']['oximeter'], fontdict={'size': 30})

        plt.text(0.1, 1.3, 'radar', fontdict={'size': 12})
        plt.text(1.1, 1.3, str(int(load_hr["1"])), fontdict={'size': 30})
        plt.text(2.1, 1.3, str(int(load_hr["2"])), fontdict={'size': 30})

        plt.text(0.8, 2.5, 'heartbeats1', fontdict={'size': 12})
        plt.text(1.1, 2.2, '(bpm)', fontdict={'size': 12})
        plt.text(2.0, 2.5, 'heartbeats2', fontdict={'size': 12})
        plt.text(2.1, 2.2, '(bpm)', fontdict={'size': 12})
        plt.axis([0, 3, 0, 3])
