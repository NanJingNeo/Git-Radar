...
%         rmseresult=sqrt(mean(indexresult/156+0.5)-t);
        indexresult_sum=[indexresult_sum;indexresult/156+0.5-t];
...
% indexresult_sum=['index';indexresult_sum]
result=[names;indexresult_sum']';

s = xlswrite('cep_25point.xls', result);
